...
Revision ID: 247d49f73a2d
Revises: 
Create Date: 2025-03-13 10:37:49.507105
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('processing', 'completed', name='orderstatus'), nullable=False),
