...
Revision ID: 9d58083964cd
Revises: 
Create Date: 2025-03-15 12:54:59.081560
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('CREATED', 'COOKING', 'READY', 'DELIVERING', 'COMPLETED', name='orderstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('delivery_type', sa.Enum('pickup', 'courier', name='deliverytype'), nullable=False),
